...
run:
	sudo docker run --network host --restart always -v ${PWD}/celery_app/src/Movies.db:/home/flask_app/Movies.db -v ${PWD}/flask_app/info.log:/home/flask_app/info.log --name flask-movie-database -p 5000:5000 -d flask-movie-database;
remove:
